...
.site-title {
  ...
  height:57px;
  margin:3rem auto;
  background:url(http://stefanmatei.com/vileworks/wp-content/uploads/2014/07/vileworks-logo.png) top center no-repeat;
  width:400px;
  text-indent:200%;
  overflow:hidden;
  white-space:nowrap;
...
#mceu_13 {
  ...
  margin:3em -4em;
  margin-bottom:3em;
  box-shadow:0 0px 2px 5px rgba(200,200,200,.4);
  display:block;
}
...
.resources a:hover, .resources a:hover .icon {
  color:#C02942;
  fill:#C02942;
}
...
<div id="content">
  ...
  <h1>Signable <br> Contract.php</h1>
  <hr>
  ...
  <h2 style="text-align:center; font-family:'Open Sans Condensed', sans; font-weight:300; line-height:1.5em; letter-spacing:.05em">
    Once <strong>signed</strong><svg xmlns="http://www.w3.org/2000/svg" class="icon" viewBox="0 0 8 8">
      <path d="M6 0l-1 1 2 2 1-1-2-2zm-2 2l-4 4v2h2l4-4-2-2z" />
    </svg> by your client, this php file will delete itself from your server and leave behind an HTML version of the contract 
     that can be 
    ...
    or downloaded as a <strong>PDF</strong><svg xmlns="http://www.w3.org/2000/svg" class="icon" viewBox="0 0 8 8">
...
--></textarea>
  ...
  <!--<div class="buttons">
    <button id="reset" type="button">Reset signature</button>
    <button id="preview" type="button" style="display:none;">Preview contract</button>
  </div>-->
  ...
  <form method="post" id="signature-form">
    ...
    </button> <small>contract-4015ce.php (you can rename this)</small>
    
    <input type="hidden" id="signature_capture" name="contractdata">
    <input type="hidden" id="html_capture" name="contractdata">
  ...
  <h2>4. Ask your client to review and sign.</h2>
...
tinymce.init({
    selector: "#input-html",
    content_css : "http://vileworks.com/contract/editor-style.css", 
    min_height: 300,
    plugins: [
